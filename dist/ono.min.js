...
"use strict";function create(r){return function(e,t,o,a){var n,l,s=module.exports.formatter;util.isString(e)?(n=s.apply(null,arguments),e=t=void 0):n=util.isString(t)?s.apply(null,slice.call(arguments,1)):s.apply(null,slice.call(arguments,2)),e instanceof Error||(t=e,e=void 0),e&&(n+=(n?" \n":"")+e.message,l=e.stack);var i=new r(n);return extendError(i,l,t),i}}function extendError(r,e,t){if(e&&(r.stack+=" \n\n"+e),util.isObject(t))for(var o=Object.keys(t),a=0;a<o.length;a++){var n=o[a];r[n]=t[n]}r.toJSON=errorToJSON}function errorToJSON(){var r={name:this.name,message:this.message},e=Object.keys(this);e=e.concat(["description","number","fileName","lineNumber","columnNumber","stack"]);for(var t=0;t<e.length;t++){var o=e[t],a=this[o];util.isUndefined(a)||(r[o]=a)}return r}var util=require("util"),slice=Array.prototype.slice;module.exports=create(Error),module.exports.error=create(Error),module.exports.eval=create(EvalError),module.exports.range=create(RangeError),module.exports.reference=create(ReferenceError),module.exports.syntax=create(SyntaxError),module.exports.type=create(TypeError),module.exports.uri=create(URIError),module.exports.formatter=util.format;
